...
software
            ...
            <td>
              ...
              TB2:Estuve a cargo de la elaboración de las Experiment Cards y la formulación de Hipótesis. Mi trabajo se enfocó en plantear hipótesis objetivas que reflejaran escenarios reales y no supuestos sesgados. Me aseguré de que las experiment cards estuvieran bien estructuradas, facilitando la trazabilidad de los objetivos del experimento y sus posibles impactos en los usuarios. Durante este proceso, mantuve un enfoque ético, evitando generar expectativas no verificables y promoviendo un análisis crítico de cada planteamiento. Esta experiencia fortaleció mi capacidad para tomar decisiones responsables en entornos de ingeniería de software.
                ...
                TF: Durante esta entrega asumí la responsabilidad de implementar las to-be user stories definidas en nuestro backlog, vinculadas a funcionalidades clave de la aplicación móvil, así como de la re-priorización de los question backlogs que requieren nuevos experimentos para futuras iteraciones bajo EDD. Esta experiencia me permitió reconocer la importancia de actuar con responsabilidad ética y profesional como Ingeniero de Software, asegurando que cada hipótesis y funcionalidad se validen de manera rigurosa y transparente para garantizar decisiones informadas, respetar a los usuarios y contribuir al desarrollo de soluciones confiables y de impacto positivo.
...
<p style="font-weight:bold"> Alexandra Belen Ramos Argüelles:</p>
              ...
              TF1: Como responsable de los Team Collaboration Insights, documenté meticulosamente el progreso del equipo, asegurando transparencia en cada fase del desarrollo de MoviRent. Además, estuve a cargo de la creación del Shareback Session Artifacts: Learning Workflow, donde analizamos las decisiones técnicas bajo un enfoque ético, promoviendo buenas prácticas como la inclusión, accesibilidad y uso responsable de datos. Mi trabajo garantizó que el equipo reflexionara sobre su impacto profesional y mantuviera altos estándares de integridad.
...
sociales
            ...
            <td>
              ...
              TP1: Al implementar mejoras en la app móvil y landing page, evalué cuidadosamente el impacto en la experiencia del usuario, priorizando accesibilidad (como compatibilidad con lectores de pantalla) y optimizando el rendimiento para reducir el consumo de batería y datos, contribuyendo a un uso más sostenible de la tecnología.
               ...
               TF: Durante esta entrega asumí la responsabilidad de implementar las to-be user stories de nuestro backlog relacionadas con la funcionalidad de la aplicación móvil, además de re-priorizar los question backlogs que requerían nuevos experimentos para futuras iteraciones de EDD. Esta experiencia me permitió emitir juicios informados al evaluar cómo cada solución impacta no solo en la calidad técnica, sino también en aspectos económicos y sociales, como la viabilidad del modelo de negocio y la accesibilidad para diversos usuarios. Reconozco la importancia de tomar decisiones de ingeniería de software considerando siempre su efecto en contextos globales y comunitarios, garantizando que las funcionalidades aporten valor real, sean sostenibles y responsables con su entorno.
<p style="font-weight:bold">Mathias Adriano Hidalgo Lopez:</p> 
...
<p style="font-weight:bold">Sebastian Valente Lobato Pozo:</p>
              ...
              TB2: Desarrollé los supuestos (Assumptions), realicé los cálculos de escala y seleccioné los KPIs y métricas. Me enfoqué en cómo nuestras decisiones técnicas podían afectar el consumo de recursos, la seguridad de los datos y el impacto ambiental del sistema. Propuse métricas que nos ayuden a medir no solo el éxito técnico, sino también la responsabilidad social de nuestras soluciones. TF: Como responsable de evidenciar los endpoints realizados y mejorados en esta entrega, evalué el impacto global de implementar funcionalidades de reportes automatizados y calificaciones en tiempo real en MoviRent. Económicamente, estas implementaciones reducen costos operativos al eliminar la intervención manual y mejoran la confianza del usuario. Ambientalmente, al facilitar el mantenimiento preventivo de scooters eléctricos a través de reportes automáticos, contribuimos a extender la vida útil de estos vehículos sostenibles. Socialmente, el sistema de calificaciones transparente democratiza la confianza en transacciones entre usuarios de scooters, mientras que las notificaciones automáticas mejoran la comunicación y responsabilidad entre propietarios y arrendatarios. 
<p style="font-weight:bold"> Alexandra Belen Ramos Argüelles:</p>
              ...
              TF1: Durante las sesiones de Continuous Learning, evalué cómo MoviRent podría reducir la congestión vehicular y su huella ambiental, priorizando funciones como el alquiler compartido de vehículos. En las entrevistas de validación. Mis aportes destacaron el equilibrio entre innovación y responsabilidad social, asegurando que el proyecto generara un impacto positivo en la comunidad.
